...
func TestIndex(t *testing.T) {
	...
	examples := map[string]testData{
		...
		"one occurrence in arr":       testData{arr: []float64{1, 4}, selector: 1, response: rutils.IntPtr(0)},
		"multiple occurrences in arr": testData{arr: []float64{1, 4, 1}, selector: 1, response: rutils.IntPtr(0)},
	}
...
func TestToStringArray(t *testing.T) {
	...
	examples := map[string]testData{
		"empty arr":         testData{arr: []float64{}, response: []string{}, err: nil},
		"just one element":  testData{arr: []float64{1}, response: []string{"1"}, err: nil},
		"multiple elements": testData{arr: []float64{2, 3, 1}, response: []string{"2", "3", "1"}, err: nil},
	}
...
func TestToFloat64Array(t *testing.T) {
	...
	examples := map[string]testData{
		"empty arr":         testData{arr: []float64{}, response: []float64{}, err: nil},
		"just one element":  testData{arr: []float64{1}, response: []float64{1}, err: nil},
		"multiple elements": testData{arr: []float64{2, 3, 1}, response: []float64{2, 3, 1}, err: nil},
	}
...
func TestToFloat32Array(t *testing.T) {
	...
	examples := map[string]testData{
		"empty arr":         testData{arr: []float64{}, response: []float32{}, err: nil},
		"just one element":  testData{arr: []float64{1}, response: []float32{1}, err: nil},
		"multiple elements": testData{arr: []float64{2, 3, 1}, response: []float32{2, 3, 1}, err: nil},
	}
...
func TestToInt64Array(t *testing.T) {
	...
	examples := map[string]testData{
		"empty arr":         testData{arr: []float64{}, response: []int64{}, err: nil},
		"just one element":  testData{arr: []float64{1}, response: []int64{1}, err: nil},
		"multiple elements": testData{arr: []float64{2, 3, 1}, response: []int64{2, 3, 1}, err: nil},
	}
...
func TestToInt32Array(t *testing.T) {
	...
	examples := map[string]testData{
		"empty arr":         testData{arr: []float64{}, response: []int32{}, err: nil},
		"just one element":  testData{arr: []float64{1}, response: []int32{1}, err: nil},
		"multiple elements": testData{arr: []float64{2, 3, 1}, response: []int32{2, 3, 1}, err: nil},
	}
...
func TestToUintArray(t *testing.T) {
	...
	examples := map[string]testData{
		"empty arr":         testData{arr: []float64{}, response: []uint{}, err: nil},
		"just one element":  testData{arr: []float64{1}, response: []uint{1}, err: nil},
		"multiple elements": testData{arr: []float64{2, 3, 1}, response: []uint{2, 3, 1}, err: nil},
	}
...
func TestToUint32Array(t *testing.T) {
	...
	examples := map[string]testData{
		"empty arr":         testData{arr: []float64{}, response: []uint32{}, err: nil},
		"just one element":  testData{arr: []float64{1}, response: []uint32{1}, err: nil},
		"multiple elements": testData{arr: []float64{2, 3, 1}, response: []uint32{2, 3, 1}, err: nil},
	}
...
func TestToUint64Array(t *testing.T) {
	...
	examples := map[string]testData{
		"empty arr":         testData{arr: []float64{}, response: []uint64{}, err: nil},
		"just one element":  testData{arr: []float64{1}, response: []uint64{1}, err: nil},
		"multiple elements": testData{arr: []float64{2, 3, 1}, response: []uint64{2, 3, 1}, err: nil},
	}
